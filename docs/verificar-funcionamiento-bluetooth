...
1. Se escribió un breve [código](pastebin.com/raw/1u1fFTeM) de prueba en VSCode que hace uso del led integrado en el chip.
2. Se construyó la imagen y se subió al ESP32 haciendo uso de la extensión PlatformIO.
3. En el celular, se descargó una [aplicación](play.google.com/store/apps/details?id=de.kai_morich.serial_bluetooth_terminal&hl=en) que permite conectarse y comunicarse por Bluetooth con nuestro chip.
